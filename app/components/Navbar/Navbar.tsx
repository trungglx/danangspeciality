...
const navigation: NavigationItem[] = [
  { name: "Giới thiệu", href: "#home-section", current: false },
  { name: "Chọn mua", href: "#about-section", current: false },
  { name: "Lịch sử", href: "#cook-section", current: false },
  { name: "Ảnh đẹp", href: "#gallery-section", current: false },
];
